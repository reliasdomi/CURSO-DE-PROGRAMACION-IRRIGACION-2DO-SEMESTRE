...
NEXT j: NEXT i
IF n MOD 2 = 1 THEN mediana = datos((n + 1) / 2) ELSE mediana = (datos(n / 2) + datos(n / 2 + 1)) / 2
LOCATE CSRLIN, 18: PRINT: LOCATE CSRLIN, 18: PRINT "Mediana ="; mediana
