' 30: PROMEDIO EDAD GRUPO - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 29: PRINT "30: PROMEDIO EDAD GRUPO"
COLOR 15, 1
LOCATE 8, 18
...
suma=0: FOR i=1 TO n: suma=suma+edad(i): NEXT i
LOCATE CSRLIN, 18: PRINT "Promedio de edad del grupo:"; suma/n; " anos"
