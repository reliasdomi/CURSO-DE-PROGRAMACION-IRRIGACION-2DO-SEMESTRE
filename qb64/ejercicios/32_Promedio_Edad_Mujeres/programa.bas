' 32: PROMEDIO EDAD MUJERES - Grupo 4A
...
suma=0: cont=0: FOR i=1 TO n: IF sexo$(i)="M" THEN suma=suma+edad(i): cont=cont+1
NEXT i
IF cont=0 THEN PRINT "No hay mujeres." ELSE PRINT "Promedio de edad de mujeres:"; suma/cont; " anos"
