' 33: PROMEDIO EDAD HOMBRES - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 28: PRINT "33: PROMEDIO EDAD HOMBRES"
COLOR 15, 1
LOCATE 8, 18
...
suma=0: cont=0: FOR i=1 TO n: IF sexo$(i)="H" THEN suma=suma+edad(i): cont=cont+1
NEXT i
IF cont=0 THEN PRINT "No hay hombres." ELSE PRINT "Promedio de edad de hombres:"; suma/cont; " anos"
