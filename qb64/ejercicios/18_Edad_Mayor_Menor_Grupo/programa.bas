' 18: EDAD MAYOR MENOR GRUPO - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 28: PRINT "18: EDAD MAYOR MENOR GRUPO"
COLOR 15, 1
LOCATE 8, 18
...
mayor=edad(1): menor=edad(1): FOR i=2 TO n: IF edad(i)>mayor THEN mayor=edad(i)
IF edad(i)<menor THEN menor=edad(i)
NEXT i
LOCATE CSRLIN, 18: PRINT "Edad mayor:"; mayor: LOCATE CSRLIN, 18: PRINT "Edad menor:"; menor
