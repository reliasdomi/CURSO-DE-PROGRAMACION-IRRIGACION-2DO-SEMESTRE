' 24: MUJERES MAYORES EDAD - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 29: PRINT "24: MUJERES MAYORES EDAD"
COLOR 15, 1
LOCATE 8, 18
...
cont=0: FOR i=1 TO n: IF sexo$(i)="M" AND edad(i)>=18 THEN cont=cont+1
NEXT i
LOCATE CSRLIN, 18: PRINT "Mujeres con 18 anos o mas:"; cont
