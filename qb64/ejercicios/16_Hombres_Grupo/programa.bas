...
COLOR 14, 1
LOCATE 6, 32: PRINT "16: HOMBRES GRUPO"
COLOR 15, 1
LOCATE 8, 18
...
cont=0: FOR i=1 TO n: IF sexo$(i)="H" THEN cont=cont+1
NEXT i
LOCATE CSRLIN, 18: PRINT "Numero de hombres:"; cont
