' 19: ESTATURA MAYOR MENOR GRUPO - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 26: PRINT "19: ESTATURA MAYOR MENOR GRUPO"
COLOR 15, 1
LOCATE 8, 18
...
mayor=est(1): menor=est(1): FOR i=2 TO n: IF est(i)>mayor THEN mayor=est(i)
IF est(i)<menor THEN menor=est(i)
NEXT i
LOCATE CSRLIN, 18: PRINT "Estatura mayor:"; mayor; " m": LOCATE CSRLIN, 18: PRINT "Estatura menor:"; menor; " m"
