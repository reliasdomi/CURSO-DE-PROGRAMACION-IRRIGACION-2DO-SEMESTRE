...
COLOR 14, 1
LOCATE 6, 33: PRINT "10: NUMERO MENOR"
COLOR 15, 1
LOCATE 8, 18
DIM datos(100)
...
menor = datos(1): FOR i = 2 TO n: IF datos(i) < menor THEN menor = datos(i)
NEXT i
LOCATE CSRLIN, 18: PRINT: LOCATE CSRLIN, 18: PRINT "El numero menor es:"; menor
