...
COLOR 14, 1
LOCATE 6, 31: PRINT "11: MEDIA ARITMETICA"
COLOR 15, 1
LOCATE 8, 18
DIM datos(100)
...
LOCATE CSRLIN, 18: PRINT: LOCATE CSRLIN, 18: PRINT "Suma  ="; suma: LOCATE CSRLIN, 18: PRINT "Media ="; suma / n
