' 20: EDAD MAYOR MENOR MUJERES - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 27: PRINT "20: EDAD MAYOR MENOR MUJERES"
COLOR 15, 1
LOCATE 8, 18
...
cont=0: FOR i=1 TO n: IF sexo$(i)="M" THEN IF cont=0 THEN mayor=edad(i): menor=edad(i)
IF sexo$(i)="M" THEN IF edad(i)>mayor THEN mayor=edad(i)
IF sexo$(i)="M" THEN IF edad(i)<menor THEN menor=edad(i)
IF sexo$(i)="M" THEN cont=cont+1
NEXT i
IF cont=0 THEN PRINT "No hay mujeres." ELSE PRINT "Edad mayor mujeres:"; mayor: LOCATE CSRLIN, 18: PRINT "Edad menor mujeres:"; menor
