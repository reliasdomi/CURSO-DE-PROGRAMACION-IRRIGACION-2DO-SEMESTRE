' 31: PROMEDIO ESTATURA GRUPO - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 27: PRINT "31: PROMEDIO ESTATURA GRUPO"
COLOR 15, 1
LOCATE 8, 18
...
suma=0: FOR i=1 TO n: suma=suma+est(i): NEXT i
LOCATE CSRLIN, 18: PRINT "Promedio de estatura del grupo:"; suma/n; " m"
