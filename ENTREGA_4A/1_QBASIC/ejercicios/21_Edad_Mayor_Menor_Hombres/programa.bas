' 21: EDAD MAYOR MENOR HOMBRES - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 27: PRINT "21: EDAD MAYOR MENOR HOMBRES"
COLOR 15, 1
LOCATE 8, 18
...
cont=0: FOR i=1 TO n: IF sexo$(i)="H" THEN IF cont=0 THEN mayor=edad(i): menor=edad(i)
IF sexo$(i)="H" THEN IF edad(i)>mayor THEN mayor=edad(i)
IF sexo$(i)="H" THEN IF edad(i)<menor THEN menor=edad(i)
IF sexo$(i)="H" THEN cont=cont+1
NEXT i
IF cont=0 THEN PRINT "No hay hombres." ELSE PRINT "Edad mayor hombres:"; mayor: LOCATE CSRLIN, 18: PRINT "Edad menor hombres:"; menor
