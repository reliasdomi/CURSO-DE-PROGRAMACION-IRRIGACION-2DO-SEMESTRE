...
COLOR 14, 1
LOCATE 6, 33: PRINT "23: MENORES EDAD"
COLOR 15, 1
LOCATE 8, 18
...
cont=0: FOR i=1 TO n: IF edad(i)<18 THEN cont=cont+1
NEXT i
LOCATE CSRLIN, 18: PRINT "Personas menores de 18 anos:"; cont
