' 29: ESTATURA MAYOR MENOR HOMBRES - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 25: PRINT "29: ESTATURA MAYOR MENOR HOMBRES"
COLOR 15, 1
LOCATE 8, 18
...
cont=0: FOR i=1 TO n: IF sexo$(i)="H" THEN IF cont=0 THEN mayor=est(i): menor=est(i)
IF sexo$(i)="H" THEN IF est(i)>mayor THEN mayor=est(i)
IF sexo$(i)="H" THEN IF est(i)<menor THEN menor=est(i)
IF sexo$(i)="H" THEN cont=cont+1
NEXT i
IF cont=0 THEN PRINT "No hay hombres." ELSE PRINT "Estatura mayor hombres:"; mayor; " m": LOCATE CSRLIN, 18: PRINT "Estatura menor hombres:"; menor; " m"
