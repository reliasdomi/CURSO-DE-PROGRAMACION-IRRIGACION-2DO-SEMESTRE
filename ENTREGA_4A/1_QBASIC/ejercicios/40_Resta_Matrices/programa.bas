...
COLOR 14, 1
LOCATE 6, 30: PRINT "40: RESTA DE MATRICES"
COLOR 15, 1
LOCATE 8, 18
...
LOCATE CSRLIN, 18: PRINT "Capture A": FOR i = 1 TO m: FOR j = 1 TO n: LOCATE CSRLIN, 18: PRINT "A("; i; ","; j; "): ";: INPUT a(i, j): NEXT j: NEXT i
LOCATE CSRLIN, 18: PRINT "Capture B": FOR i = 1 TO m: FOR j = 1 TO n: LOCATE CSRLIN, 18: PRINT "B("; i; ","; j; "): ";: INPUT b(i, j): c(i, j) = a(i, j) - b(i, j): NEXT j: NEXT i
LOCATE CSRLIN, 18: PRINT: LOCATE CSRLIN, 18: PRINT "C = A - B": FOR i = 1 TO m: FOR j = 1 TO n: LOCATE CSRLIN, 18: PRINT c(i, j);: NEXT j: LOCATE CSRLIN, 18: PRINT: NEXT i
