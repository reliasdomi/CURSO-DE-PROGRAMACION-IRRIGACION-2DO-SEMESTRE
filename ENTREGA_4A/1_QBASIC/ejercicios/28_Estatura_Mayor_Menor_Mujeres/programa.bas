' 28: ESTATURA MAYOR MENOR MUJERES - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 25: PRINT "28: ESTATURA MAYOR MENOR MUJERES"
COLOR 15, 1
LOCATE 8, 18
...
cont=0: FOR i=1 TO n: IF sexo$(i)="M" THEN IF cont=0 THEN mayor=est(i): menor=est(i)
IF sexo$(i)="M" THEN IF est(i)>mayor THEN mayor=est(i)
IF sexo$(i)="M" THEN IF est(i)<menor THEN menor=est(i)
IF sexo$(i)="M" THEN cont=cont+1
NEXT i
IF cont=0 THEN PRINT "No hay mujeres." ELSE PRINT "Estatura mayor mujeres:"; mayor; " m": LOCATE CSRLIN, 18: PRINT "Estatura menor mujeres:"; menor; " m"
