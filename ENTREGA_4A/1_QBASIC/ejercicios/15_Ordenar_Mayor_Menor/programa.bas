' 15: ORDENAR DE MAYOR A MENOR - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 27: PRINT "15: ORDENAR DE MAYOR A MENOR"
COLOR 15, 1
LOCATE 8, 18
DIM datos(100)
...
FOR i = 1 TO n - 1: FOR j = 1 TO n - i: IF datos(j) < datos(j + 1) THEN temp = datos(j): datos(j) = datos(j + 1): datos(j + 1) = temp
NEXT j: NEXT i
LOCATE CSRLIN, 18: PRINT: LOCATE CSRLIN, 18: PRINT "Datos ordenados:";: FOR i = 1 TO n: LOCATE CSRLIN, 18: PRINT datos(i);: NEXT i: LOCATE CSRLIN, 18: PRINT
