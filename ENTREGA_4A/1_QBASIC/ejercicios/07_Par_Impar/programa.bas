' 07: NUMERO PAR O IMPAR - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 30: PRINT "07: NUMERO PAR O IMPAR"
COLOR 15, 1
LOCATE 8, 18
INPUT "Escriba un numero entero: ", n
IF n MOD 2 = 0 THEN PRINT n; " es PAR" ELSE PRINT n; " es IMPAR"
