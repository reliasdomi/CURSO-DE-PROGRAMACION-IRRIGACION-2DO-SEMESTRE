...
{ ------------------------------------------------------------------
  ...
  VARIANTE UNA VENTANA: captura del grupo y submenu dibujados dentro
  de la ventana grafica; el nombre se teclea con Lee_cadena.
  ------------------------------------------------------------------ }
...
var i: integer;
begin
  Abre_ventana('CAPTURA DEL GRUPO DE PERSONAS');
  N := Lee_entero_rango('Cuantas personas (2 a ' + Entero_a_Cadena(MAXP, 1) +
       '): ', 2, MAXP);
  for i := 1 to N do
  begin
    Abre_ventana('PERSONA ' + Entero_a_Cadena(i, 1) + ' DE ' +
                 Entero_a_Cadena(N, 1));
    Nombre[i]   := Lee_cadena('Nombre: ');
...
begin
  ...
  repeat
    op := Pantalla_menu('PERSONAS / POBLACIONALES (16-35)  -  ' +
      Entero_a_Cadena(N, 1) + ' personas',
      ['16. Hombres en el grupo          26. Hombres mayores de edad',
       '17. Mujeres en el grupo          27. Hombres menores de edad',
       '18. Edad mayor/menor grupo       28. Estatura may/men mujeres',
       '19. Estatura mayor/menor grupo   29. Estatura may/men hombres',
       '20. Edad may/men mujeres         30. Promedio edad grupo',
       '21. Edad may/men hombres         31. Promedio estatura grupo',
       '22. Mayores de edad (>=18)       32. Promedio edad mujeres',
       '23. Menores de edad (<18)        33. Promedio edad hombres',
       '24. Mujeres mayores de edad      34. Promedio estatura mujeres',
       '25. Mujeres menores de edad      35. Promedio estatura hombres',
       '',
       '98. Capturar otro grupo          0. Volver al menu principal'],
      0, 98);
    case op of
