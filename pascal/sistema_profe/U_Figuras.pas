...
{ ------------------------------------------------------------------
  ...
  Cada figura: se piden los datos por consola (Val), se calcula area y
  perimetro, y se DIBUJA con primitivas reales de la unit Graph
  (Line, Rectangle, Circle) igual que el GRAFICOS.PAS del profesor.
  Paridad 1:1 con las figuras de QBASIC.
  ------------------------------------------------------------------ }
...
begin
  WriteLn; WriteLn('=== AREA Y PERIMETRO DEL TRAPECIO ISOSCELES ===');
