' 04: AREA Y CIRCUNFERENCIA DEL CIRCULO - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 22: PRINT "04: AREA Y CIRCUNFERENCIA DEL CIRCULO"
COLOR 15, 1
LOCATE 8, 18
pi = 4 * ATN(1)
DO: INPUT "Radio (> 0): ", radio: LOOP UNTIL radio > 0
LOCATE CSRLIN, 18: PRINT: LOCATE CSRLIN, 18: PRINT "Area           ="; pi * radio * radio; " unidades cuadradas"
LOCATE CSRLIN, 18: PRINT "Circunferencia ="; 2 * pi * radio; " unidades"
GOSUB DibujaCirculo
