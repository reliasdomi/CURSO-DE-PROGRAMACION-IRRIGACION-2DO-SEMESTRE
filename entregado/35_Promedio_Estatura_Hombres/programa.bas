' 35: PROMEDIO ESTATURA HOMBRES - Grupo 4A
...
COLOR 14, 1
LOCATE 6, 26: PRINT "35: PROMEDIO ESTATURA HOMBRES"
COLOR 15, 1
LOCATE 8, 18
...
suma=0: cont=0: FOR i=1 TO n: IF sexo$(i)="H" THEN suma=suma+est(i): cont=cont+1
NEXT i
IF cont=0 THEN PRINT "No hay hombres." ELSE PRINT "Promedio de estatura de hombres:"; suma/cont; " m"
